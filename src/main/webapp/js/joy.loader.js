...
var WebNoSecurityUrl = "../../html/site/login.html"; 
var AgencyNoSecurityUrl = "../../html/agency/login.html"; 
var rootUrl = "http://"+window.location.host+"/kq";
var ImageBrowser = {
        transport: {
             read: { //删除
                 url: rootUrl+"/so/cm/soCmDocumentAction.do?action=searchFile",
                 type: "POST",
                 dataType:"json"
             },
             destroy: { //删除
                 url: rootUrl+"/so/cm/soCmDocumentAction.do?action=deleteFile",
                 type: "POST",
                 dataType:"json"
             },
             thumbnailUrl:rootUrl+"/so/cm/soCmDocumentAction.do?action=downloadFile", //缩略图
             uploadUrl: rootUrl+"/so/cm/soCmDocumentAction.do?action=uploadEditorFile",
             imageUrl: rootUrl+"/so/cm/soCmDocumentAction.dox?action=downloadFile&id={0}"
        }
     };//图片管理器定义
